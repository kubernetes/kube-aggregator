...
require (
	...
	k8s.io/apiserver v0.0.0-20210518112717-0be3b216342a
	k8s.io/client-go v0.0.0-20210518102847-bfec2914ea57
	k8s.io/code-generator v0.0.0-20210518095629-dd2ded1d0f40
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20210518112717-0be3b216342a
