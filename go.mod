...
require (
	...
	k8s.io/client-go v0.0.0-20220712172946-59fda2e6695f
	k8s.io/code-generator v0.0.0-20220711091613-d665e29a7d2b
...
replace (
	...
	k8s.io/client-go => k8s.io/client-go v0.0.0-20220712172946-59fda2e6695f
