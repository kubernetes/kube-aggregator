...
require (
	...
	k8s.io/apiserver v0.0.0-20220329131945-e4a0d4ca4925
	k8s.io/client-go v0.0.0-20220329091314-94a1081fafd8
	k8s.io/code-generator v0.0.0-20220329130608-15a5f67a8af0
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20220329131945-e4a0d4ca4925
