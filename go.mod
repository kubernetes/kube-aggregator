...
require (
	...
	k8s.io/apiserver v0.0.0-20220317024620-c23778950215
	k8s.io/client-go v0.0.0-20220319171433-c47b8028952e
	k8s.io/code-generator v0.0.0-20220318020739-3e006776d5ff
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20220317024620-c23778950215
